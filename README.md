...
Accuracy: It measures the correctly classified samples.
Precision: It measures the model’s ability to avoid false positives.
Recall: It measures the model's ability to detect true malware samples.
